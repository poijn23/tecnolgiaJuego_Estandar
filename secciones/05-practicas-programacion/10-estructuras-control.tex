...
\noindent\hangindent=1.25em\hangafter=1 Dijkstra, E.~W. (1968). Go to statement considered harmful. \textit{Communications of the ACM, 11}(3), 147--148. \url{https://doi.org/10.1145/362929.362947}
...
\smallskip
\noindent\hangindent=1.25em\hangafter=1 Microsoft. (2023, 29 de septiembre). \textit{IDE0011: Add braces}. Microsoft Learn. \url{https://learn.microsoft.com/en-us/dotnet/fundamentals/code-analysis/style-rules/ide0011}

\smallskip
\noindent\hangindent=1.25em\hangafter=1 Microsoft. (2026a, 16 de enero). \textit{If and switch statements: Select a code path to execute}. Microsoft Learn. \url{https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/statements/selection-statements}

\smallskip
\noindent\hangindent=1.25em\hangafter=1 Microsoft. (2026b, 16 de enero). \textit{Iteration statements: for, foreach, do, and while}. Microsoft Learn. \url{https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/statements/iteration-statements}
